...
public class ServicesInteressantsFragment extends Fragment implements DataLoadCallback {
	...
	public static ServicesInteressantsFragment newInstance() {
		ServicesInteressantsFragment fragment = new ServicesInteressantsFragment();
		return fragment;
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.services_interessants_fragment, container, false);
	...
	private void initView() {
		...
		mListView.setOnRefreshListener(new CustomListView.OnRefreshListener() {
			...
			public void onRefresh() {
				start = 0;
				MissionManager.getInstance().missionsSuiviesChat(lang,Constant.REFRESH_DATA_FINISH, connectedUser,String.valueOf(start), String.valueOf(limit),password,ServicesInteressantsFragment.this);
			}
		});
		mListView.setOnLoadListener(new CustomListView.OnLoadMoreListener() {
			@Override
			public void onLoadMore() {
				MissionManager.getInstance().missionsSuiviesChat(lang,Constant.LOAD_DATA_FINISH,connectedUser,String.valueOf(start), String.valueOf(limit),password,ServicesInteressantsFragment.this);
			...
			public void onItemClick(AdapterView<?> paramAnonymousAdapterView,
				   ...
				   Mission mission = (Mission) mAdapter.getMissions().get(position - 1);
		            if (Integer.parseInt(mission.getStatut()) != 5) {
		                ...
		                ServicesInteressantsFragment.this.getActivity().startActivityForResult(mainIntent, 101);
		            }
			}
		});
