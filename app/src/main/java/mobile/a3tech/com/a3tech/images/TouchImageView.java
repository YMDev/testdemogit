...
public class TouchImageView extends ImageView {
    ...
    /* renamed from: ma.education.images.TouchImageView.1 */
    ...
    private void sharedConstructing(Context context) {
        ...
        this.f58m = new float[9];
        setImageMatrix(this.matrix);
        setScaleType(ScaleType.MATRIX);
        setOnTouchListener(new C07031());
    }
    ...
    void fixTrans() {
        this.matrix.getValues(this.f58m);
        float transX = this.f58m[ZOOM];
        float transY = this.f58m[5];
