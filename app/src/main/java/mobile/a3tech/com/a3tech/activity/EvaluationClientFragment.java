...
public class EvaluationClientFragment extends Fragment implements DataLoadCallback {
	...
	public static EvaluationClientFragment newInstance() {
		EvaluationClientFragment fragment = new EvaluationClientFragment();
        return fragment;
    }
	...
	private void initView() {
		...
		idEvaluation_listViewEvaluations.setOnRefreshListener(new CustomListView.OnRefreshListener() {
			...
			public void onRefresh() {
				start = 0;
				EvaluationManager.getInstance().listeEvaluation(lang,Constant.REFRESH_DATA_FINISH,connectedUser, "2", String.valueOf(start), String.valueOf(limit),password, EvaluationClientFragment.this);
		...
		idEvaluation_listViewEvaluations.setOnLoadListener(new CustomListView.OnLoadMoreListener() {
			...
			public void onLoadMore() {
				EvaluationManager.getInstance().listeEvaluation(lang,Constant.LOAD_DATA_FINISH,connectedUser, "2", String.valueOf(start), String.valueOf(limit),password, EvaluationClientFragment.this);
