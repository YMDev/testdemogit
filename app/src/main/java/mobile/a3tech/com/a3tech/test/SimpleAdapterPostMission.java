...
public class SimpleAdapterPostMission extends RecyclerView.Adapter<SimpleAdapterPostMission.SimpleItemVH> {
    ...
    public SimpleAdapterPostMission(Context context) {
        this.context = context;
    }

    public SimpleAdapterPostMission(Context context, List objectMenu) {
        this.context = context;
